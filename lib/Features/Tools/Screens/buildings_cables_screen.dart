...
class BuildingsCablesScreen extends StatefulWidget {
  static const route = '/BuildingsCablesScreen';

  @override
  _BuildingsCablesScreenState createState() => _BuildingsCablesScreenState();
}

class _BuildingsCablesScreenState extends State<BuildingsCablesScreen> {
  bool firstCategorySelected = true;
  bool showLayer2 = false;
