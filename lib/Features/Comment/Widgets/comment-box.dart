...
class CommentBox extends StatelessWidget {
  final CommentItem items;
  CommentBox(this.items);
  @override
  Widget build(BuildContext context) {
    ...
    var _commentWriter = items.user;
    var _commentDate = items.createdAt;
    var _commentContent = items.message;
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Icon(
                              ...
                              size: 3.5 * _deviceWidthBlockSize,
                            ),
                          ),
                        ],
                      ),
